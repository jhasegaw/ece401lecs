...
\title{Lecture 11: Discrete-Time Filtering of Continuous-Time Signals}
...
\begin{frame}
  ...
  \item $p(t)=\sinc\left(\frac{\pi t}{T_s}\right)$ $\Rightarrow$ perfectly bandlimited interpolation,
    $y(t)$ has no spectral components above $F_S/2$
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  We'll derive a more useful general form for the rectangular averager
  later in the course.  But for now, let's try this:
  \begin{align*}
