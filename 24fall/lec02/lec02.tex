...
\begin{frame}
  ...
  \centerline{\includegraphics[height=2.5in]{exp/sohcahtoa.png}}
  \begin{tiny}
    By Cmglee, CC-SA 4.0,
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=\textwidth]{exp/sine_and_cosine.png}}
  \begin{tiny}
...
\begin{frame}
  ...
  \]
  \centerline{\includegraphics[height=2in]{exp/Oscillating_sine_wave.png}}
\end{frame}  
...
\begin{frame}
  \frametitle{Phase, Distance, and Time}
  \centerline{\includegraphics[height=2.5in]{exp/Oscillating_sine_wave.png}}
  \begin{tiny}
...
\begin{frame}
  ...
  \centerline{\includegraphics[height=2.5in]{exp/Euler.png}}
  \begin{tiny}
...
\begin{frame}
  ...
  \centerline{\includegraphics[height=2.5in]{exp/Complex_conjugate_picture.png}}
  \begin{tiny}
...
\begin{frame}
  ...
  \end{align*}
  \centerline{\includegraphics[height=1.75in]{exp/Vector_Addition.png}}
  \begin{tiny}
...
\begin{frame}
  ...
  \centerline{\includegraphics[height=2.5in]{exp/startrek.jpg}}
  \begin{tiny}
