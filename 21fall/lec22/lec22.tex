...
\begin{frame}
  ...
  h_{LPF}[m]=\frac{\sin(\omega_L n)}{\pi n}
  \]
\end{frame}
...
\begin{frame}
  ...
  \begin{align*}
    &H_{BPF}(\omega)=H_{LPF}(\omega|\omega_L)-H_{LPF}(\omega|\omega_H)\\
    &\leftrightarrow~~~ h_{BPF}[n]=\frac{\sin(\omega_L n)}{\pi n}-\frac{\sin(\omega_H n)}{\pi n}
  \end{align*}
\end{frame}
...
\begin{frame}
  ...
  \begin{align*}
    H_{HPF}(\omega)&=e^{-j\omega n_0}\left(1-H_{HPF}(\omega)\right)\\
    &\leftrightarrow\\
