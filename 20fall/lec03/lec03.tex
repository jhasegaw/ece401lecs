...
\begin{frame}
  ...
  \centerline{\includegraphics[height=2.5in]{startingpoints.png}}
\end{frame}
...
\begin{frame}
  ...
  \centerline{\includegraphics[height=3in]{phaseshift.png}}
\end{frame}
...
\begin{frame}
  ...
  OK, what about that triple-beat example that I used to start this section?
  \[
  \cos(2\pi 107t) + \cos(2\pi 110t)+\cos(2\pi 104t)=\mbox{???}
  \]
  This is like a time-varying phasor example.
  \begin{enumerate}
  \item First, decide what frequency to base the phasors on.  The math
    is more or less complicated depending on which frequency we
    choose, but here, the average frequency works well:
    \[
    f = \frac{107+110+104}{3} = 107\mbox{Hz}
    \]
  \item Second, express this using phasors:
    \begin{align*}
      x(t) &= \Re\left\{\left(1+e^{j2\pi 3t}+e^{-j2\pi 3t}\right)e^{j2\pi 107t}\right\}\\
      &= \Re\left\{\left(1+2\cos\left(2\pi 3t\right)\right)e^{j2\pi 107t}\right\}\\
      &= (1+2\cos(2\pi 3 t))\cos\left(2\pi 107t\right)
    \end{align*}
  \end{enumerate}
\end{frame}
...
\begin{frame}
  ...
  \centerline{\includegraphics[height=3in]{triplebeat.png}}
\end{frame}
